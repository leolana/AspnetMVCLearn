...
Execute the install command in the root directory of "aspnetmvclearnpresentation" repository.

```shell
$ cd path/to/aspnetmvclearnpresentation
...
This project is created on 2016-05-21 using [generator-markup-markdown](https://github.com/ogaoga/generator-markup-markdown) v0.1.0.
